...
function woothemes_more_themes_page(){
       ...
       //global $options, $themename, $manualurl;
        ...
        ul.themes li.theme .theme-info {margin-left: 480px; }
        ul.themes li.theme .theme-info h2.title { background: #eee; padding: 10px 20px; margin-bottom: 10px; border-bottom:1px #ddd solid; border-top:1px #e1e1e1 solid}
        ...
        ul.themes li.theme .theme-info .entry { width: 60%; padding-left: 20px;}
        ul.themes li.theme .theme-info .entry p{ font-size: 14px!important;  margin: 20px 10px 25px 10px; }
        ul.themes li.theme .theme-info ul {padding-left: 40px; color: #ccc; float:left; border-top:#eee 1px solid; padding-top: 20px; }
        ul.themes li.theme .theme-info ul li { list-style: disc;}
        ul.themes li.theme .theme-info ul li a:link, 
        ul.themes li.theme .theme-info ul li a:visited { font-size: 14px!important; text-decoration: none;}
...
add_action('admin_head', 'woothemes_more_themes_head');
